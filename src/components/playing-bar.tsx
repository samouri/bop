...
class PlayingBar extends React.Component<Props> {
  ...
  playNextSong = () =>
    this.props.dispatch(playSong({ songId: this.props.nextSong.id }));
  playPrevSong = () =>
    this.props.dispatch(playSong({ songId: this.props.prevSong.id }));
      ...
      <div className="playing-bar">
        <div className="playing-bar__width-wrapper">
          ...
          <div className="playing-bar__play-controls">
            <i
              className="fa fa-2x fa-fast-backward pointer"
              onClick={this.playPrevSong}
            />
            <i className={playOrPauseClasses} onClick={this.handlePausePlay} />
            <i
              className="fa fa-2x fa-fast-forward pointer"
