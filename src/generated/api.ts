...
export const MetadataApiFetchParamCreator = {
     ...
     * @param body metadata
     */
	metadataPost(params: { prefer?: string; body?: Metadata }, options: any = {}): FetchArgs {
		const baseUrl = `/metadata`;
		let urlObj = url.parse(baseUrl, true);
...
export const MetadataApiFp = {
	...
	metadataDelete(
		...
		const fetchArgs = MetadataApiFetchParamCreator.metadataDelete(params, options);
		return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
			return fetch(basePath + fetchArgs.url, fetchArgs.options).then(response => {
				if (response.status >= 200 && response.status < 300) {
					return response;
	...
	metadataPatch(
		...
		const fetchArgs = MetadataApiFetchParamCreator.metadataPatch(params, options);
		return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
			return fetch(basePath + fetchArgs.url, fetchArgs.options).then(response => {
				if (response.status >= 200 && response.status < 300) {
					return response;
	...
	metadataPost(
		...
		const fetchArgs = MetadataApiFetchParamCreator.metadataPost(params, options);
		return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
			return fetch(basePath + fetchArgs.url, fetchArgs.options).then(response => {
				if (response.status >= 200 && response.status < 300) {
					return response;
...
export class MetadataApi extends BaseAPI {
	...
	metadataDelete(
		...
		return MetadataApiFp.metadataDelete(params, options)(this.fetch, this.basePath);
	}
	/**
     * 
     * @param range Limiting and Pagination
	...
	metadataGet(
		...
		return MetadataApiFp.metadataGet(params, options)(this.fetch, this.basePath);
	}
	/**
     * 
     * @param prefer Preference
	...
	metadataPatch(
		...
		return MetadataApiFp.metadataPatch(params, options)(this.fetch, this.basePath);
	}
	/**
     * 
     * @param prefer Preference
     * @param body metadata
     */
	metadataPost(params: { prefer?: string; body?: Metadata }, options: any = {}) {
		return MetadataApiFp.metadataPost(params, options)(this.fetch, this.basePath);
	}
}
...
export const PlaylistsApiFetchParamCreator = {
     ...
     */
	playlistsDelete(
		params: { prefer?: string; id?: string; name?: string; userAdded?: string; dateAdded?: string },
		options: any = {}
	): FetchArgs {
     ...
     * @param body playlists
     */
	playlistsPost(params: { prefer?: string; body?: Playlists }, options: any = {}): FetchArgs {
		const baseUrl = `/playlists`;
		let urlObj = url.parse(baseUrl, true);
		let fetchOptions: RequestInit = assign({}, { method: 'POST' }, options);
...
export const PlaylistsApiFp = {
	...
	playlistsDelete(
		...
		const fetchArgs = PlaylistsApiFetchParamCreator.playlistsDelete(params, options);
		return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
			return fetch(basePath + fetchArgs.url, fetchArgs.options).then(response => {
				if (response.status >= 200 && response.status < 300) {
					return response;
	...
	playlistsGet(
		...
		const fetchArgs = PlaylistsApiFetchParamCreator.playlistsGet(params, options);
		return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
			return fetch(basePath + fetchArgs.url, fetchArgs.options).then(response => {
				if (response.status >= 200 && response.status < 300) {
					return response;
	...
	playlistsPatch(
		...
		const fetchArgs = PlaylistsApiFetchParamCreator.playlistsPatch(params, options);
		return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
			return fetch(basePath + fetchArgs.url, fetchArgs.options).then(response => {
				if (response.status >= 200 && response.status < 300) {
					return response;
	...
	playlistsPost(
		...
		const fetchArgs = PlaylistsApiFetchParamCreator.playlistsPost(params, options);
		return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
			return fetch(basePath + fetchArgs.url, fetchArgs.options).then(response => {
				if (response.status >= 200 && response.status < 300) {
					return response;
...
export class PlaylistsApi extends BaseAPI {
	...
	playlistsDelete(
		...
		return PlaylistsApiFp.playlistsDelete(params, options)(this.fetch, this.basePath);
	}
	/**
     * 
     * @param range Limiting and Pagination
	...
	playlistsGet(
		...
		return PlaylistsApiFp.playlistsGet(params, options)(this.fetch, this.basePath);
	}
	/**
     * 
     * @param prefer Preference
	...
	playlistsPatch(
		...
		return PlaylistsApiFp.playlistsPatch(params, options)(this.fetch, this.basePath);
	}
	/**
     * 
     * @param prefer Preference
     * @param body playlists
     */
	playlistsPost(params: { prefer?: string; body?: Playlists }, options: any = {}) {
		return PlaylistsApiFp.playlistsPost(params, options)(this.fetch, this.basePath);
	}
}
...
export const SongsApiFetchParamCreator = {
     ...
     * @param body songs
     */
	songsPost(params: { prefer?: string; body?: Songs }, options: any = {}): FetchArgs {
		const baseUrl = `/songs`;
		let urlObj = url.parse(baseUrl, true);
		let fetchOptions: RequestInit = assign({}, { method: 'POST' }, options);
...
export const UsersApiFetchParamCreator = {
     ...
     */
	usersDelete(
		params: { prefer?: string; id?: string; username?: string; password?: string },
		options: any = {}
	): FetchArgs {
		const baseUrl = `/users`;
		let urlObj = url.parse(baseUrl, true);
     ...
     */
	usersPatch(
		params: { prefer?: string; body?: Users; id?: string; username?: string; password?: string },
		options: any = {}
	): FetchArgs {
		const baseUrl = `/users`;
		let urlObj = url.parse(baseUrl, true);
     ...
     * @param body users
     */
	usersPost(params: { prefer?: string; body?: Users }, options: any = {}): FetchArgs {
		const baseUrl = `/users`;
		let urlObj = url.parse(baseUrl, true);
		let fetchOptions: RequestInit = assign({}, { method: 'POST' }, options);
...
export const VotesApiFetchParamCreator = {
     ...
     * @param body votes
     */
	votesPost(params: { prefer?: string; body?: Votes }, options: any = {}): FetchArgs {
		const baseUrl = `/votes`;
		let urlObj = url.parse(baseUrl, true);
		let fetchOptions: RequestInit = assign({}, { method: 'POST' }, options);
