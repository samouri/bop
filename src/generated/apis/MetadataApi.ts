...
import { Metadata, MetadataFromJSON, MetadataToJSON } from '../models'
...
export class MetadataApi extends runtime.BaseAPI {
  /**
   */
  async metadataDeleteRaw(
    requestParameters: MetadataDeleteRequest
  ...
  /**
   */
  async metadataPatchRaw(
    requestParameters: MetadataPatchRequest
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: runtime.HTTPQuery = {}
  ...
  /**
   */
  async metadataPostRaw(
    requestParameters: MetadataPostRequest
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: runtime.HTTPQuery = {}
